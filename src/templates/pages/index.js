  ...
  var popularBannerHtml = generatePopularBanner();
    ...
    if (format === 'vertical') {
	  ...
	  function adSlotMobile(id, extraClass, adSlotId, adFormat) {
	    ...
	    // 가로형: 320x100 고정
	    if (isHorizontal) {
	      return '<div class="ad-slot ad-slot-section mobile-only' + shapeClass + ' ' + (extraClass || '') + '" id="' + id + '"><ins class="adsbygoogle" style="display:inline-block;width:320px;height:100px" data-ad-client="ca-pub-9477874183990825" data-ad-slot="' + slotId + '"></ins>' + pushScript + '</div>';
	    }
	    // 직사각형: rectangle 클래스 적용 (336x280 고정)
	    if (isRectangle) {
	      return '<div class="ad-slot ad-slot-section mobile-only ad-slot--rectangle ' + (extraClass || '') + '" id="' + id + '"><ins class="adsbygoogle" style="display:inline-block;width:336px;height:280px" data-ad-client="ca-pub-9477874183990825" data-ad-slot="' + slotId + '"></ins>' + pushScript + '</div>';
	    }
	    return '<div class="ad-slot ad-slot-section mobile-only' + shapeClass + ' ' + (extraClass || '') + '" id="' + id + '"><ins class="adsbygoogle" style="display:inline-block;width:320px;height:100px" data-ad-client="ca-pub-9477874183990825" data-ad-slot="' + slotId + '"></ins>' + pushScript + '</div>';
	  }
	  ...
	  var topAdMobile = SHOW_ADS ? '<div class="ad-slot ad-slot-section ad-slot--horizontal mobile-only" id="home-top-ad-mobile"><ins class="adsbygoogle" style="display:inline-block;width:320px;height:100px" data-ad-client="ca-pub-9477874183990825" data-ad-slot="' + AD_SLOTS.horizontal5 + '"></ins><script>(adsbygoogle = window.adsbygoogle || []).push({});<\/script></div>' : '';

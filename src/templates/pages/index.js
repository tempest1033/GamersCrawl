  ...
  var popularBannerHtml = generatePopularBanner();
    ...
    if (format === 'vertical') {
	  ...
	  function adSlotMobile(id, extraClass, adSlotId, adFormat) {
	    ...
	    if (isHorizontal) {
	      return '<ins class="adsbygoogle mobile-only ad-slot-section ' + (extraClass || '') + '" id="' + id + '" style="display:block;width:100%" data-ad-client="ca-pub-9477874183990825" data-ad-slot="' + slotId + '" data-ad-format="horizontal"></ins>' + pushScript;
	    }
	  ...
	  var topAdMobile = SHOW_ADS ? '<ins class="adsbygoogle mobile-only ad-slot-section" id="home-top-ad-mobile" style="display:block;width:100%" data-ad-client="ca-pub-9477874183990825" data-ad-slot="' + AD_SLOTS.horizontal5 + '" data-ad-format="horizontal"></ins><script>(adsbygoogle = window.adsbygoogle || []).push({});<\/script>' : '';

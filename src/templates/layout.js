...
function generateAdSlot(slotIdPc, slotIdMobile, extraClass = '') {
  ...
  <div class="ad-slot ad-slot-section ad-slot--horizontal mobile-only ${extraClass}" style="height:120px">
    <ins class="adsbygoogle" style="display:block;width:100%;height:120px" data-ad-client="ca-pub-9477874183990825" data-ad-slot="${mobileSlot}"></ins>
  </div>`;
}

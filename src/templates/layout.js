...
function generateAdSlot(slotIdPc, slotIdMobile, extraClass = '') {
  ...
  <div class="ad-slot ad-slot-section ad-slot--horizontal mobile-only ${extraClass}">
    <ins class="adsbygoogle" style="display:block;width:100%" data-ad-client="ca-pub-9477874183990825" data-ad-slot="${mobileSlot}" data-full-width-responsive="true"></ins>
  </div>`;
}
